...
export default function AuthorityForgotPassword() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#06152a]">
      {/* Background - Same as your Authority Login */}
        ...
        <div className="bg-[#0c1e3a]/80 backdrop-blur-xl border border-blue-500/20 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-6">
            <h2 className="text-white text-[22px] font-semibold flex items-center justify-center gap-2">
              <span className="text-emerald-400">🛡️</span> Authority Reset
            </h2>
            <p className="text-blue-300/70 text-[13px] mt-1">
              Reset your authority credentials
            </p>
          </div>
          ...
          <div className="text-center mt-6 space-y-2">
            <Link to="/authority" className="block text-[12px] text-cyan-300/80 hover:text-cyan-300">
              ← Back to Authority Login
            </Link>
            <p className="text-[11px] text-blue-300/50">
              Not an authority? <Link to="/user/login" className="text-cyan-300/70">User login</Link>
            </p>
          </div>
        </div>
      </div>
