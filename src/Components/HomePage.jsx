...
const HomePage = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-screen max-w-7xl mx-auto px-6 sm:px-12 md:px-16 lg:px-20">
        
        {/* Floating Navigation Bar */}
        <nav className="mt-6 flex items-center justify-between px-6 py-3 bg-[#0a1628]/80 border border-teal-500/20 rounded-full backdrop-blur-md shadow-lg shadow-black/40">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm text-gray-300">
            <a href="#" className="text-white border-b-2 border-teal-400 pb-0.5">Home</a>
            <a href="#" className="hover:text-white transition-colors">How it Works</a>
            <a href="#" className="hover:text-white transition-colors">Authorities</a>
          ...
          <div className="flex items-center gap-3">
            <button className="bg-teal-400 hover:bg-teal-300 text-black text-sm font-semibold px-5 py-2 rounded-full transition-all shadow-[0_0_15px_rgba(45,212,191,0.4)]">
              Track Complaint
            </button>
            <button className="bg-teal-400 hover:bg-teal-300 text-black text-sm font-semibold px-5 py-2 rounded-full transition-all shadow-[0_0_15px_rgba(45,212,191,0.4)]">
              Report Issue
        ...
        {/* Hero Section */}
        <section className="flex-1 flex flex-col md:flex-row items-center justify-between text-center gap-12 py-20 md:py-28">
...
<div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
  ...
  {/* Middle - tumhare text ke aas paas */}
  ...
  <div className="flex flex-wrap items-center justify-center gap-4 mt-2 z-20 relative">
    <button className="bg-[#2CF6B3] hover:bg-[#1de5a2] text-black font-bold text-sm px-8 py-3 rounded-lg shadow-[0_0_20px_rgba(45,246,179,0.3)] transition-all">
      User Login
    </button>
     <button className="bg-[#2CF6B3] hover:bg-[#1de5a2] text-black font-bold text-sm px-8 py-3 rounded-lg shadow-[0_0_20px_rgba(45,246,179,0.3)] transition-all">
      User Login
            ...
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 flex items-center justify-center">
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="relative">
                  <div className="absolute -inset-4 bg-teal-400 rounded-full blur-xl opacity-70 animate-pulse"></div>
